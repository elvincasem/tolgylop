...
?>
    ...
    <title>
        ...
        Notifications &middot Friend Request 
    ...
    echo "$years years ago";
        ...
        <?php   
                                      ...
                                      <div class="media-heading">
                                        <img class = "img-circle media-object" src="../img/'.$imahe.'">
                                         <div class="media-left">
                                            <span class="icon icon-user text-muted"></span> <a href="../search.php?search='.$request.'"><strong>'.$request.'</strong></a> Following you
                                         </div>';
                                       
                        echo '<br>';
                        echo '<form method = "post" action = "../assets/updateStatus.php">';
                        echo '<input type="hidden" name="follower" id="follower" value="'.$follower.'">';
                        echo '<input type="hidden" name="following" id="following" value="'.$following.'">';                   
                        echo            '<button class="btn btn-primary-outline btn-sm id="insert" type="submit">';
                        echo               '<span class="icon icon-add-user"></span> Confirm</button>';
                        echo '</form>';
                        echo '     </div> 
                                 </div>
                             </li>';
                    ...
                    <?php   
                      ...
                      $account = $conn->prepare("SELECT tblfriendlist.mainuserid, frienduserid, currentDate, userid,firstname,lastname,email,profileP 
                        FROM tblfriendlist,tbluser WHERE tblfriendlist.mainuserid = tbluser.userid 
                        AND tblfriendlist.frienduserid = '$uid' AND status = 1 order by tblfriendlist.friendid DESC");
                      $account->execute();
                      ////"SELECT * FROM tblfriendlist WHERE frienduserid = '$uid' "
                      while($result = $account->fetch(PDO::FETCH_ASSOC)){
                        $imahe = $result['profileP'];
                        ...
                        echo       '</small>
                                      <div class="media-heading">
                                        <img class = "img-circle media-object" src="../img/'.$imahe.'">
                                         <div class="media-left">
                                            <span class="icon icon-user text-muted"></span> <a href="../search.php?search='.$request.'"><strong>'.$request.'</strong></a> is now following you
                                         </div>';
