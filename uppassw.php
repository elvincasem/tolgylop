...
<title>Polyglot</title>
	...
	<div class = "row">
		...
		<div class="col-sm-4">
			<div id = "greet">
			<center>You've now retrieved your account!</center><br>
			</div>
			<div class="col-lg-2">
			</div>
...
<?php
		...
		$conn = dbConnect();
		$account = $conn->prepare("Update tbluser Set  password = '$pass' WHERE email = '$email'");
		$account->execute();
...
?>
					...
					<center><a href = "index.php">Go Back and Log In</a></center>
