...
<title>Polyglot</title>
	...
	<div class = "row">
		...
		<div class="col-sm-7">
			<div id = "greet">
			<center>Sorry Cannot Process Please try again</center>
			</div>
			<div class="col-lg-2">
			</div>
	...
	<div class = "row">
		...
		<div id = "cont" class="col-sm-4">
			<center>
			<button name="submit" id="submit" class="btn btn-danger button hvr-grow"  size="20px"><a href = "index.php">go back to sign up</a></button>
		</center>
		</div>
	</div>		
